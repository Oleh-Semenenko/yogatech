...
const cooperationBenefits: IFeature[] = [
  ...
  {
    id: 4,
    title: 'Співпрацюйте з експертами',
    text: 'Ми глибоко переконані у тому, що разом ми здатні на більше! Якщо ви маєте власну студію або хист до організації - ми можемо познайомити вас із експертами для спільного проведення потужних ретритів та цікавих  подій! Зі свого боку, ми виступаємо гарантом якості, а також допомагатимемо з рекламою.',
    color: 'var(--orange)'
  }
]
</script>
